...
namespace UIToolkitDemo
{
    ...
    public class HomeScreenController : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            MenuEvents.PlayButtonClicked += OnPlayGameLevel;
        }
        ...
        void Start()
        {
            // MenuEvents.LevelInfoShown?.Invoke(m_LevelData);
            // MenuEvents.ChatWindowShown?.Invoke(m_ChatData);
        }
        ...
        public void OnPlayGameLevel()
        {
            ...
            MenuEvents.MenuScreenHidden?.Invoke();

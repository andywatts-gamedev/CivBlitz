...
public class TurnManager : Singleton<TurnManager>
{
    ...
    private IEnumerator DoAITurn() {
        ...
        // Move each AI unit
        while (UnitManager.Instance.units.Any(u => u.Value.civ == aiCiv && u.Value.movement > 0))
        {
            ...
            if (!UnitManager.Instance.TryGetUnit(from, out var unit) || unit.movement <= 0) continue;
